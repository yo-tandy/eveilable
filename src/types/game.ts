...
export type GameType = 'divided-attention' | 'double-decision' | 'comprehension' | 'speed-summary' | 'icon-swap' | 'tense-rewrite' | 'verb-fill' | 'card-recall' | 'sentence-memory' | 'oral-writing'
